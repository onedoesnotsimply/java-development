...
public class Northwind4 {
    public static void main(String[] args) {
        ...
        try(Connection connection = dataSource.getConnection())//Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/northwind", "root","password");)
        {
            while (choice!=0){
                System.out.println("""
