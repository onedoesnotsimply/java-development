 ...
 * Usage example:
 * <pre>
 * TurtlePaint.src.main.java.com.pluralsight.forms.World w = new TurtlePaint.src.main.java.com.pluralsight.forms.World();
 *
 * TurtlePaint.src.main.java.com.pluralsight.forms.Turtle t = new TurtlePaint.src.main.java.com.pluralsight.forms.Turtle(w);
 * t.forward(300);
 * t.setPenWidth(10);
 * t.backward(100);
 * t.right(135);
...
public class Turtle {
     ...
     * Should only be called by TurtlePaint.src.main.java.com.pluralsight.forms.World class
    ...
    /**
     * Returns the current Color of the TurtlePaint.src.main.java.com.pluralsight.forms.Turtle.
    ...
    /**
     * Changes the current Color of the TurtlePaint.src.main.java.com.pluralsight.forms.Turtle.
    ...
    /**
     * Find out what direction the TurtlePaint.src.main.java.com.pluralsight.forms.Turtle is facing
    ...
    /**
     * Set the direction the TurtlePaint.src.main.java.com.pluralsight.forms.Turtle is facing
